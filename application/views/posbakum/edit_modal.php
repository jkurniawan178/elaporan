    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Ubah Laporan Pelaksanaan Posbakum</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="edit_form" action="<?php echo base_url() . 'LIPA_16/posbakum/ubah_aksi' ?>" method="post" class="form-horizontal form-label-left needs-validation" novalidate>
                <div class="modal-body">
                    <div class="row form-group">
                        <label id="periode_label" class="col-form-label col-md-4 d-flex justify-content-md-end" for="bulan_modal">Periode <span class="required text-danger">*</span>
                        </label>
                        <div class="col-md-8">
                            <div class="row">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="number" id="edit_jml_layanan" name="jml_layanan" required="required" class="form-control">
                            <div class="invalid-feedback">
