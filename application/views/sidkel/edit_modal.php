            ...
            <form id="edit_form" action="<?php echo base_url() . 'LIPA_14/sidkel/ubah_aksi' ?>" method="post" class="form-horizontal form-label-left needs-validation" novalidate>
                <div class="modal-body">
                    <div class="row form-group">
                        <label id="periode_label" class="col-form-label col-md-4 col-sm-4 d-flex justify-content-md-end" for="bulan_modal">Periode <span class="required text-danger">*</span>
                        </label>
                        <div class="col-md-8">
                            <div class="row">
                    ...
                    <div class="row form-group">
                        <label for="jml_kegiatan" class="col-form-label col-md-4 d-flex justify-content-md-end">Jumlah Kegiatan<span class="required text-danger">*</span></label>
                        <div class="col-md-8">
