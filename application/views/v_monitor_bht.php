    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h2>Monitoring Perkara Putus Belum BHT</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Monitoring Perkara yang Putus Belum BHT Berdasarkan Panitera Pengganti</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#btn_tampil').on('click', function() {
            const jenis_monitor = 'monitoring_perkara_putus_belum_BHT';
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('index.php/monitoring_bht/get_monitor_bht') ?>",
                dataType: "JSON",
                data: {
