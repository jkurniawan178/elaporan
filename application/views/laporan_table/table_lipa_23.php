<div class="table-responsive">
    <table class="text-center table table-striped table-bordered" id="table_lipa23" cellspacing="0" width="100%">
    ...
    function generateTableRows(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            table.row.add([
                ...
                addThousandSeparator(data[i].putus_elektronik),
                addThousandSeparator(data[i].putus_biasa),
                addThousandSeparator(data[i].total_putus),
