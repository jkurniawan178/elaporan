<div class="table-responsive">
    <table class="text-center table table-striped table-bordered" id="table_penyerahan_salinan" cellspacing="0" width="100%">
        <thead class="bg-success text-dark">
            <tr>
                <th scope="col" rowspan="2" class="align-middle p-2">No</th>
                <th scope="col" rowspan="2" class="align-middle p-2">Nomor Perkara</th>
                <th scope="col" rowspan="2" class="align-middle p-2">Jenis Perkara</th>
                <th scope="colgroup" colspan="3" class="align-middle p-2">Tanggal</th>
            ...
            <tr>
                <th scope="col" class="align-middle p-2">Pendaftaran</th>
...
<script>
    function generateTableRows(data) {
        const table = $('#table_penyerahan_salinan').DataTable({
            order: [
                [0, 'asc']
            ],
            "bFilter": false,
        ...
        for (var i = 0; i < valueData.length; i++) {
            ...
            table.row.add([
                ...
                formatDate(valueData[i].tanggal_transaksi),
                pilihPihak(valueData[i].alur_perkara_id, valueData[i].jenis_perkara_id, valueData[i].penerima),
                "-"
            ])
        }
        table.draw();
