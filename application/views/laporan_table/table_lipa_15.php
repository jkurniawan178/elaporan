<div class="table-responsive">
    <table class="text-center table table-striped table-bordered" id="table_lipa15">
...
<script>
    function generateTableRows(data) {
        const table = $('#table_lipa15').DataTable({
            order: [
                [0, 'asc']
            ],
            "bFilter": false,
        ...
        for (let i = 0; i < data.length; i++) {
            table.row.add([
                ...
                addThousandSeparator(data[i].target_perkara),
