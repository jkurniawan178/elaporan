        ...
        <div class="modal-content">
            ...
            <form id="edit_form" action="<?php echo base_url() . 'LIPA_14/pagu_14/ubah_aksi'; ?>" method="post" class="form-horizontal form-label-left needs-validation" novalidate>
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <label for="lokasi" class="col-form-label col-md-4 d-flex justify-content-md-end">Target Lokasi <span class="required text-danger">*</span></label>
                        <div class="col-md-8">
                    ...
                    <div class="row form-group">
                        <label for="kegiatan" class="col-form-label col-md-4 d-flex justify-content-md-end">Target Kegiatan <span class="required text-danger">*</span></label>
                        <div class="col-md-8">
